...
namespace Board
{
    public partial class FrmSearch : Form
    {
        ...
        public void SearchInfo()
        {
            ...
            /*string sql = @"Select s.id,b.boardName,s.intendedName,s.startTime,s.duration,s.enteringName,s.reason from Schedulelnfo s
                            Insert join Schedulelnfo b on s.boardroomId = b.id
                            where 1 = 1";
            if (txtName.Text != "")
            {
                sql += "and intendeName like '%" + txtName.Text + "%'"
            }*/
            //调用查询方法
